    ...
    <>
      ...
      <div className="flex flex-row justify-around items-center mt-10">
        ...
        <div className="max-w-sm w-full lg:max-w-full lg:flex">
          ...
          <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            ...
            <div className="flex items-center">
              <img className="w-10 h-10 rounded-full mr-4" src="https://www.rae.es/sites/default/files/styles/wysiwyg_100_/public/2021-07/ramdomtwitter_Mesa%20de%20trabajo%201.png?itok=JfO9YVoD" alt="Avatar of Jonathan Reinink" />
        ...
        <div className="bg-indigo-300 ...">
          <Logo className="object-cover h-48 w-96" />
